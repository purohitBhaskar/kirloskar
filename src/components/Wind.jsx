...
//           <div className="wind-right-row-power-phase">
...
//           </div>
//           <div className="wind-right-row-kW">
...
//           </div>
//           <div className="wind-right-row-kVA">
...
const Wind = () => {
  return (
    <div className='wind-container'>
      <div className="wind-left-section">
        <div className="img-section" id="wind-img"></div>
        <div className="wind-cards-section">
          <div className="wind-card-section-card" id="card-1">
          ...
          <div className="wind-card-section-card" id="card-2">
          ...
          <div className="wind-card-section-card" id="card-3">
          ...
          <div className="wind-card-section-card" id="card-4">
        ...
        <div className="wind-notifications-section">
          <div className="wind-notifications-section-heading">Notifications</div>
          <div className="wind-notifications-section-table">
            <div className="wind-notifications-section-table-table-row1">
              <div className="fault-code">Fault Code</div>
              <div className="description">Description</div>
              <div className="severity">Severity</div>
              <div className="status">Status</div>
            ...
            <div className="wind-notifications-section-table-table-row2">
            ...
            <div className="wind-notifications-section-table-table-row3">
      ...
      <div className="wind-right-section">
        <div className="wind-right-section-row1">
        ...
        <div className="wind-right-section-row2">
        ...
        <div className="wind-right-section-row3">
          <div className="card1">
        ...
        <div className="wind-right-section-row4">
