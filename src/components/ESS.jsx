  ...
  return (
    <div className="ess-container">
      <div className="ess-left-section">
        ...
        <div className="ess-bottom-left">
          <div className="ess-stat-cards">
            <div className="ess-stat-card" id="ess-stat-card-1">
            ...
            <div className="ess-stat-card" id="ess-stat-card-4">
            ...
            <div className="ess-stat-card" id="ess-stat-card-5">
            ...
            <div className="ess-stat-card" id="ess-stat-card-6">
            ...
            <div className="ess-stat-card" id="ess-stat-card-7">
            ...
            <div className="ess-stat-card" id="ess-stat-card-8">
            ...
            <div className="ess-stat-card" id="ess-stat-card-9">
      ...
      <div className="ess-right-section">
        <div className="ess-right-row1">
          <div className="ess-operating-hours-total-gen-heading">
          ...
          <div className="ess-operating-hours-total-gen-values">
        ...
        <div className="ess-right-row2"></div>
        <div className="ess-right-row3">
          <div className="ess-right-row-power-phase">
          ...
          <div className="ess-right-row-kW">
          ...
          <div className="ess-right-row-kVA">
        ...
        <div className="ess-right-row4">
          <div className="ess-voltage-current-phase-heading">
        ...
        <div className="ess-right-row5">
          ...
          <div className="ess-notification-table">
            <div className="ess-notification-table-heading">
            ...
            <div className="ess-notification-table-row-1">
            ...
            <div className="ess-notification-table-row-2">
