...
//         <div className="biogas-left-section-rows" id='biogas-img'>
...
//           <div className="biogas-vertical-card1">
//             <div className="biogas-vertical-card1-maintenance">Maintenace</div>
//             <div className="biogas-vertical-card1-last-date">Last Date: <br /></div>
//             <div className="biogas-vertical-card1-next-due">Due Date: <br /></div>

//           </div>
//           <div className="biogas-vertical-card2">
//             <div className="biogas-vertical-card2-utilization-factor">Utilisation<br />factor</div>
//             <div className="biogas-vertical-card2-utilization-factor-value">83%</div>
//             <div className="biogas-vertical-card2-power-factor">Power Factor</div>
//             <div className="biogas-vertical-card2-power-factor-value">0.6</div>
//           </div>
//           <div className="biogas-vertical-card3">
//             <div className="biogas-vertical-card3-notifications">Notifications</div>
//             <div className="biogas-vertical-card3-alerts">Alerts: <br /></div>
//             <div className="biogas-vertical-card3-shutdowns">Shutdowns: <br /></div>
//           </div>
//           <div className="biogas-vertical-card4">
//             <div className="biogas-vertical-card4-frequency">frequency</div>
//             <div className="biogas-vertical-card4-frequency-value">50 Hz</div>
//             <div className="biogas-vertical-card4-breaker-status">Breaker Status</div>
//             <div className="biogas-vertical-card4-breaker-status-on-off-trip">On/Off/Trip</div>
//           </div>
//         </div>
//         <div className="left-section-rows" id='notifications'>
//           <div className="biogas-notifications-heading">Notifications</div>
//           <div className="biogas-notifications-row-1">
...
//           </div>
//           <div className="biogas-notifications-row-2">
...
//           </div>
//           <div className="biogas-notifications-row-3">
//             <div className="fault-code-value">1234</div>
//             <div className="description-value">Blockage Detected</div>
...
//           <div className="biogas-yesterday-stats">
//             <div className="biogas-yesterday-stats-heading">Yesterday</div>
//             <div className="biogas-yesterday-hours-operated">Hours <br />Operated</div>
//             <div className="biogas-yesterday-power-generated">
//               Power <br />Generated <br />(kWh)
//             </div>
//             <div className="biogas-yesterday-hours-operated-reading">4</div>
//             <div className="biogas-yesterday-power-generated-reading">24</div>
//           </div>
//         </div>
...
//           <div className="biogas-right-row-power-phase">
...
//           </div>
//           <div className="biogas-right-row-kW">
...
//           </div>
//           <div className="biogas-right-row-kVA">
...
//           <div className="biogas-operating-hours">
//             <div className="biogas-operating-hours-heading">Operating <br />Hours</div>
//             <div className="biogas-operating-hours-reading">426 hrs</div>
//           </div>
//           <div className="biogas-total-generation">
//             <div className="biogas-total-generation-heading">Total <br />Generation</div>
//             <div className="biogas-total-generation-reading">473 kWh</div>
//           </div>
//           <div className="biogas-total-utilization">
//             <div className="biogas-total-utilization-heading">Total <br />Utilization</div>
//             <div className="biogas-total-utilization-reading">387 kWh</div>
//           </div>
//           <div className="biogas-total-savings">
//             <div className="biogas-total-savings-heading">Total <br />Savings</div>
//             <div className="biogas-total-savings-reading">Rs.10,000</div>
//           </div>
//         </div>
...
const Biogas = () => {
  return (
    <div className='biogas-container'>
      <div className="biogas-left-section">
        <div className="img-section" id="biogas-img"></div>
        <div className="biogas-cards-section">
          <div className="biogas-card-section-card" id="card-1">
          ...
          <div className="biogas-card-section-card" id="card-2">
          ...
          <div className="biogas-card-section-card" id="card-3">
          ...
          <div className="biogas-card-section-card" id="card-4">
        ...
        <div className="biogas-notifications-section">
          <div className="biogas-notifications-section-heading">Notifications</div>
          <div className="biogas-notifications-section-table">
            <div className="biogas-notifications-section-table-table-row1">
              <div className="fault-code">Fault Code</div>
              <div className="description">Description</div>
              <div className="severity">Severity</div>
              <div className="status">Status</div>
            ...
            <div className="biogas-notifications-section-table-table-row2">
            ...
            <div className="biogas-notifications-section-table-table-row3">
      ...
      <div className="biogas-right-section">
        <div className="biogas-right-section-row1">
        ...
        <div className="biogas-right-section-row2">
        ...
        <div className="biogas-right-section-row3">
          <div className="card1">
        ...
        <div className="biogas-right-section-row4">
