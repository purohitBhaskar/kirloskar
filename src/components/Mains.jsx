...
//         <div className="mains-left-section-rows" id='mains-img'>
...
//           <div className="mains-vertical-card1">
//             <div className="mains-vertical-card1-maintenance">Maintenace</div>
//             <div className="mains-vertical-card1-last-date">Last Date: <br /></div>
//             <div className="mains-vertical-card1-next-due">Due Date: <br /></div>

//           </div>
//           <div className="mains-vertical-card2">
//             <div className="mains-vertical-card2-utilization-factor">Utilisation<br />factor</div>
//             <div className="mains-vertical-card2-utilization-factor-value">83%</div>
//             <div className="mains-vertical-card2-power-factor">Power Factor</div>
//             <div className="mains-vertical-card2-power-factor-value">0.6</div>
//           </div>
//           <div className="mains-vertical-card3">
//             <div className="mains-vertical-card3-notifications">Notifications</div>
//             <div className="mains-vertical-card3-alerts">Alerts: <br /></div>
//             <div className="mains-vertical-card3-shutdowns">Shutdowns: <br /></div>
//           </div>
//           <div className="mains-vertical-card4">
//             <div className="mains-vertical-card4-frequency">frequency</div>
//             <div className="mains-vertical-card4-frequency-value">50 Hz</div>
//             <div className="mains-vertical-card4-breaker-status">Breaker Status</div>
//             <div className="mains-vertical-card4-breaker-status-on-off-trip">On/Off/Trip</div>
//           </div>
//         </div>
//         <div className="left-section-rows" id='notifications'>
//           <div className="mains-notifications-heading">Notifications</div>
//           <div className="mains-notifications-row-1">
...
//           </div>
//           <div className="mains-notifications-row-2">
...
//           </div>
//           <div className="mains-notifications-row-3">
//             <div className="fault-code-value">1234</div>
//             <div className="description-value">Blockage Detected</div>
...
//           <div className="mains-yesterday-stats">
//             <div className="mains-yesterday-stats-heading">Yesterday</div>
//             <div className="mains-yesterday-hours-operated">Hours <br />Operated</div>
...
//             <div className="mains-operating-hours-heading">Operating <br />Hours</div>
//             <div className="mains-operating-hours-reading">426 hrs</div>
//           </div>
//           <div className="mains-total-generation">
//             <div className="mains-total-generation-heading">Total <br />Generation</div>
//             <div className="mains-total-generation-reading">473 kWh</div>
//           </div>
//           <div className="mains-total-utilization">
//             <div className="mains-total-utilization-heading">Total <br />Utilization</div>
//             <div className="mains-total-utilization-reading">387 kWh</div>
//           </div>
//           <div className="mains-total-savings">
//             <div className="mains-total-savings-heading">Total <br />Savings</div>
//             <div className="mains-total-savings-reading">Rs.10,000</div>
//           </div>
//         </div>
...
const Mains = () => {
  return (
    <div className='mains-container'>
      <div className="mains-left-section">
        <div className="img-section" id="mains-img"></div>
        <div className="mains-cards-section">
          <div className="mains-card-section-card" id="card-1">
          ...
          <div className="mains-card-section-card" id="card-2">
          ...
          <div className="mains-card-section-card" id="card-3">
          ...
          <div className="mains-card-section-card" id="card-4">
        ...
        <div className="mains-notifications-section">
          <div className="mains-notifications-section-heading">Notifications</div>
          <div className="mains-notifications-section-table">
            <div className="mains-notifications-section-table-table-row1">
              <div className="fault-code">Fault Code</div>
              <div className="description">Description</div>
              <div className="severity">Severity</div>
              <div className="status">Status</div>
            ...
            <div className="mains-notifications-section-table-table-row2">
            ...
            <div className="mains-notifications-section-table-table-row3">
      ...
      <div className="mains-right-section">
        <div className="mains-right-section-row1">
        ...
        <div className="mains-right-section-row2">
        ...
        <div className="mains-right-section-row3">
          <div className="card1">
        ...
        <div className="mains-right-section-row4">
